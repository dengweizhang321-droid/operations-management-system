"""SQL-owned, append-only renderer-10 prepublication attestations."""
from django.db import models


class AiBusinessPromotionBudgetV10Attestation(models.Model):
    ...
    class Meta:
        db_table = "ai_business_promotion_budget_v10_attestations"
