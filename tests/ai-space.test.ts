...
test("AI Space routes and UI preserve role, private-object, and six-workspace contracts", async () => {
  ...
  assert.match(moduleView, /\["agents", "memory", "space", "management", "scheduled", "configuration"\]/);
  assert.match(catalog, /ai: \{ defaultView: "assistant", views: \["assistant", "agents", "memory", "space", "management", "scheduled", "configuration"\] \}/);
