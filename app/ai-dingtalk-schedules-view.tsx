...
export default function AiDingTalkSchedulesView() {
  ...
  return <section className="panel ai-admin-card ai-ding-schedules">
    <div className="section-header"><div><h3>钉钉定时任务</h3><p>按上海时间执行只读 AI 指令，并将结果发给已绑定的本人或已批准的群。创建任务不会直接发送。</p></div><button type="button" className="secondary-button" onClick={() => { setDraft(empty()); setEditing(true); }} disabled={busy}>新增任务</button></div>
