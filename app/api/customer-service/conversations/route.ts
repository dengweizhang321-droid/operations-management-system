...
export async function GET(request: Request) {
  try {
    ...
    const payload = await listCustomerServiceConversations({ shopName: url.searchParams.get("shopName"), startDate: url.searchParams.get("startDate"), endDate: url.searchParams.get("endDate"), agent: url.searchParams.get("agent"), status: url.searchParams.get("status"), robotScope: url.searchParams.get("robotScope"), problemType: url.searchParams.get("problemType"), conversionStatus: url.searchParams.get("conversionStatus"), category: url.searchParams.get("category"), query: url.searchParams.get("query"), skuIds: url.searchParams.get("skuIds"), spuIds: url.searchParams.get("spuIds"), page: Number(url.searchParams.get("page") || 1), pageSize: Number(url.searchParams.get("pageSize") || 30), includeOptions: url.searchParams.get("includeOptions") !== "false" });
