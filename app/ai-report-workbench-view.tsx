...
type Detail = { item: Run; snapshot?: { schemaVersion?: string }; sections?: { title: string; body: string }[]; contentError?: string; delivery: { status: string; channelId: string } | null; workflow: { id: string; status: string; version: number; retryable: boolean; nodes: Node[] } };
