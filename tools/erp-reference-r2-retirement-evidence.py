#!/usr/bin/env python3
"""Prove that the legacy erp-reference upload R2 namespace is empty."""
...
FORMAT_VERSION = "erp-reference-r2-retirement-evidence-v1"
# Legacy erp-reference uploads reused the inventory chunk uploader. Inventory
...
def collect(root: Path) -> dict[str, object]:
    ...
    if object_count or object_bytes or multipart_uploads or multipart_parts:
        raise RuntimeError("legacy erp-reference R2 namespace is not empty")
    return {
