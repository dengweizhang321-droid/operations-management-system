const message = [
  ...
  "Migration 0092_sales_domain_retirement.sql is operator-only; migrations 0093_finance_write_authority.sql, 0094_netshop_write_authority.sql, 0095_market_netshop_projection.sql, 0096_netshop_domain_retirement.sql, 0097_market_write_authority.sql, and 0098_market_domain_retirement.sql are operator-only; all are intentionally excluded from the Drizzle journal.",
