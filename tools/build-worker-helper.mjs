...
const mutableRootDeclarations = new Map([
  ...
  ["tools/tmall-direct-product-master-export.ts", 'const projectRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "..");'],
  ["tools/tmall-direct-promotion-export.ts", 'const projectRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "..");'],
