...
export const GLOBAL_SEARCH_SCHEMA_TABLE_AUDIT = {
  ...
  excludedSensitiveOrInternal: [
    ...
    "market_image_cache", "market_price_band_versions", "market_price_band_items",
    "market_master_mapping_rules", "market_download_configs", "market_download_tasks", "market_master_audit_logs",
  ],
} as const;
