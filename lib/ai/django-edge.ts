...
function surface(value: unknown): AiToolSurface {
  if (!["ai_chat", "dingtalk_chat", "ai_agent", "ai_sandbox", "business_collection", "business_agent_v2", "business_agent_budget_v1", "business_agent_integrated_v1", "business_agent_screening_v1"].includes(String(value))) throw denied();
