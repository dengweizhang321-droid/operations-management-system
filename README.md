...
2026-09-12 用户批准的**丽力每日 MTOP 分批 + 天猫店铺独立执行**已完成隔离开发验证，尚未生产采用。指定 9 月 11 日 22:44:54 的旧丽力任务将在切换维护窗口归档作废，当前仍保留；不得将下述旧版串行/丽力三日规则作为新目标，也不得提前宣称已经切换。范围、测试和采用门禁见 [独立执行方案](docs/TMALL_STORE_ISOLATION.md)。
