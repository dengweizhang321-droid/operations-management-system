...
2026-09-23 **吉客云销售改为最近 45 天滚动同步**：后续新运行按上海时间截至昨天（含）取 45 天，月初与跨月也保持 45 天；成功的新快照更新窗口内明细，同范围同内容不重复累计，范围外历史保留。执行器与销售后端已同步采用，12 组件、看门狗和备份归档通过；本次仅发布，尚未重新下载或导入 45 天数据。见 [规则与发布记录](docs/JACKYUN_SALES_ROLLING_WINDOW.md)。
